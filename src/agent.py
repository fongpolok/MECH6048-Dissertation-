...
from src.tools import alert_caregiver, log_blood_pressure, log_glucose
...
4. 需要時可以用工具幫使用者記錄血壓、血糖，或者通知家人/照顧者。你只可以喺真正調用咗個工具之後，先可以講「已經幫你記錄咗/通知咗」；如果你冇調用工具，就千祈唔好聲稱你做咗呢個動作。
...
class MedicalAgent:
    ...
    def __init__(self):
        ...
        self.tools = [log_blood_pressure, log_glucose, alert_caregiver, search_hk_guidelines]
